...
PLAYER_AURA_SYMBOLS = ["✦", "✧", "⚝", "✦", "✧", "⚝", "✦", "✧"]
PLAYER_AURA_RADIUS = 90
PLAYER_AURA_ROTATION_SPEED = 0.0005
PLAYER_AURA_COLOR = (255, 214, 107, 180)

SHOP_ANIM_DURATION = 250

# ========== АНИМАЦИИ UI ==========
UI_ANIM_DURATION = 400         # длительность появления панели (мс)
UI_STAGGER_DELAY = 40           # задержка между появлением кнопок (мс)
UI_SLIDE_DISTANCE = 10          # расстояние "выезда" панели (пикс.)