...
UNIT_TYPES = {
    'pawn': {'name': 'PAWN', 'hp': 10, 'damage': (1, 4), 'color': (255, 255, 255), 'speed': 6},
    'knight': {'name': 'KNIGHT', 'hp': 18, 'damage': (1, 3), 'color': (255, 215, 0), 'speed': 3},
    'archer': {'name': 'ARCHER', 'hp': 7, 'damage': (3, 6), 'color': (144, 238, 144), 'speed': 7},
    'mage': {'name': 'MAGE', 'hp': 8, 'damage': (4, 7), 'color': (138, 43, 226), 'speed': 6},
}
...
from config import get_music_volume
